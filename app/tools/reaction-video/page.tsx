...
export default function ReactionVideoPage() {
  ...
  const checkAccess = async () => {
    ...
    try {
      const response = await fetch(`/api/check-access?email=${encodeURIComponent(email)}&toolName=reaction-video-generator`);
      const data = await response.json();
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setSuccessMessage('Your reaction video is being processed! You\'ll receive an email when it\'s ready.');
      setTiktokUrl('');
      setVideoFile(null);
      setSelectedStyle('');
    } catch (err) {
    ...
    <>
      ...
      <div className="main-content" style={{ paddingTop: '120px' }}>
        <div className="glitch-container">
          <h1 className="main-title" data-text="REACTION VIDEO">REACTION VIDEO</h1>
          <h1 className="main-title" data-text="GENERATOR">GENERATOR</h1>
        </div>
        ...
        <div style={{ maxWidth: '800px', margin: '0 auto 3rem', textAlign: 'center' }}>
          <p style={{ fontSize: '1.1rem', color: '#ccc', lineHeight: '1.8', marginBottom: '1.5rem' }}>
            Record yourself reacting to TikToks or Reels. We'll professionally composite your reaction 
            with the original video and deliver a polished final edit ready to post.
          </p>
          ...
          <div style={{ 
            ...
            <h3 style={{ color: '#00ff88', fontSize: '1.2rem', marginBottom: '1rem', fontWeight: '700' }}>
              How It Works:
            </h3>
            <ol style={{ color: '#ddd', fontSize: '1rem', lineHeight: '1.8', paddingLeft: '1.5rem' }}>
              <li><strong>Record your reaction</strong> - Film yourself watching and reacting to the content</li>
              <li><strong>Upload your video</strong> - Provide your reaction video (.mov or .mp4, up to 500MB)</li>
              <li><strong>Share the source</strong> - Paste the TikTok or Instagram Reel URL you're reacting to</li>
              <li><strong>Choose your style</strong> - Select where your reaction appears (bottom right, top left, etc.)</li>
              <li><strong>Get your edit</strong> - We composite both videos together and email you the final result</li>
            </ol>
          </div>
        </div>
          ...
          <>
            <div style={{ 
              ...
              <div className="form-group" style={{ marginTop: '1.5rem' }}>
                ...
                <div style={{ display: 'flex', gap: '0.5rem' }}>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      background: validatingPromo ? '#555' : 'linear-gradient(135deg, #00ff88, #00aaff)',
                      border: 'none',
                      color: '#000',
                      fontSize: '0.9rem',
                      fontWeight: '700',
                ...
                {promoError && (
                  <div style={{ marginTop: '0.5rem', color: '#ff0080', fontSize: '0.9rem' }}>
                    {promoError}
                  </div>
                )}
              </div>
              ...
              <button
                ...
                style={{
                  ...
                  padding: '1rem 2rem',
                  marginTop: '1.5rem',
                  background: checkingAccess ? '#555' : 'linear-gradient(135deg, #00ff88, #00aaff)',
                  border: 'none',
                  color: '#000',
                  fontSize: '1.1rem',
                  fontWeight: '700',
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{ 
            ...
            <div style={{
              ...
              <div style={{ fontSize: '3rem', fontWeight: '900', color: '#00ff88', marginBottom: '1rem' }}>
                ${discountPercent > 0 ? (27 * (1 - discountPercent / 100)).toFixed(0) : '27'}
                <span style={{ fontSize: '1.2rem', color: '#aaa' }}>/mo</span>
              </div>
              {discountPercent > 0 && (
                <div style={{ color: '#00ff88', marginBottom: '0.5rem', fontSize: '0.9rem' }}>
                  <s style={{ color: '#666' }}>$27</s> Save ${(27 * discountPercent / 100).toFixed(0)}!
                </div>
              )}
            ...
            <div style={{
              background: 'linear-gradient(135deg, rgba(255,0,128,0.15), rgba(136,0,255,0.15))',
              ...
              <div style={{ fontSize: '3rem', fontWeight: '900', color: '#ff0080', marginBottom: '0.5rem' }}>
                ${discountPercent > 0 ? (270 * (1 - discountPercent / 100)).toFixed(0) : '270'}
                <span style={{ fontSize: '1.2rem', color: '#aaa' }}>/yr</span>
              </div>
              {discountPercent > 0 && (
                <div style={{ color: '#ff0080', marginBottom: '0.5rem', fontSize: '0.9rem' }}>
                  <s style={{ color: '#666' }}>$270</s> Save ${(270 * discountPercent / 100).toFixed(0)}!
                </div>
              )}
              <p style={{ color: '#ff0080', marginBottom: '0.5rem', fontWeight: '600' }}>
            ...
            <div style={{
              ...
              <div style={{ fontSize: '3rem', fontWeight: '900', color: '#ffaa00', marginBottom: '1rem' }}>
                ${discountPercent > 0 ? (397 * (1 - discountPercent / 100)).toFixed(0) : '397'}
              </div>
              {discountPercent > 0 && (
                <div style={{ color: '#ffaa00', marginBottom: '0.5rem', fontSize: '0.9rem' }}>
                  <s style={{ color: '#666' }}>$397</s> Save ${(397 * discountPercent / 100).toFixed(0)}!
                </div>
              )}
          ...
          <div style={{ 
            ...
            <div className="form-group" style={{ marginBottom: '1.5rem' }}>
              <label className="form-label">Source Video URL (The video you're reacting to) *</label>
              <input
                type="url"
                className="form-input"
              ...
              <p style={{ fontSize: '0.85rem', color: '#888', marginTop: '0.5rem' }}>
                Paste the TikTok or Instagram Reel URL you filmed yourself reacting to
              </p>
            </div>
            ...
            <div className="form-group" style={{ marginBottom: '1.5rem' }}>
              ...
              >
                ...
                {videoFile ? (
                  <div>
                    <p style={{ color: '#00ff88', fontWeight: '600', marginBottom: '0.5rem' }}>
                      {videoFile.name}
                    </p>
                    <p style={{ color: '#aaa', fontSize: '0.9rem' }}>
                      {(videoFile.size / (1024 * 1024)).toFixed(2)} MB
                    </p>
                    <p style={{ color: '#00aaff', fontSize: '0.9rem', marginTop: '0.5rem' }}>
            ...
            <div className="form-group" style={{ marginBottom: '1.5rem' }}>
              <label className="form-label">Position Style (Where your reaction appears on screen) *</label>
              <select
                className="form-input"
                value={selectedStyle}
            ...
            <button
              ...
              style={{
                width: '100%',
                padding: '1rem 2rem',
                background: submitting ? '#555' : 'linear-gradient(135deg, #00ff88, #00aaff)',
                border: 'none',
                color: '#000',
                fontSize: '1.1rem',
                fontWeight: '700',
