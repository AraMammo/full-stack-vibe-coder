/**
 * API Route: Execute ShipKit
 *
 * POST /api/shipkit/execute
 * Triggers the ShipKit Orchestrator to execute prompts for a project
 */

import { NextRequest, NextResponse } from 'next/server';
import { ShipKitOrchestrator } from '@/lib/agents/shipkit-orchestrator';
...
export async function POST(request: NextRequest) {
  try {
    ...
    // ============================================
    // PAYMENT VERIFICATION (skip for free tier)
    // ============================================
    if (validatedData.tier !== BIABTier.VALIDATION_PACK) {
      ...
      console.log(`[API] Free tier — skipping payment verification`);
    }
