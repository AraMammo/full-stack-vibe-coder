...
export function ShipKitReady({
  ...
  return (
    <div className="relative mb-8 overflow-hidden rounded-xl border-2 border-green-400/50 bg-gradient-to-br from-green-900/30 via-emerald-900/20 to-cyan-900/30 p-6">
      {/* Confetti particles */}
      {showConfetti && (
      ...
      <div className="relative z-10">
        <div className="mb-4 flex items-center gap-3">
          ...
          <div>
            <h3 className="text-xl font-bold text-white">Your ShipKit is Ready!</h3>
