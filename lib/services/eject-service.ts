 ...
 * Eject Service
 *
 * Allows customers to take their app off Full Stack Vibe Coder infrastructure
...
export function generateMigrationGuide(): string {
  return `# Migration Guide: Self-Hosting Your Full Stack Vibe Coder App

## Overview

This guide walks you through running your app on your own infrastructure after ejecting from Full Stack Vibe Coder.
...
Generated by Full Stack Vibe Coder on ${new Date().toISOString()}
`;
}
...
export function generateEnvExample(): string {
  return `# ================================
# Full Stack Vibe Coder App - Environment Variables
# ================================
